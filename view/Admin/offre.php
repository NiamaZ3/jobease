                        ...
                        <tr class="freelancer">
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <p class="fw-bold mb-1 f_name"><?= $numbre ?></p>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="f_position"><?= $row["location"] ?></td>
                            <td class="">
                                <a href="?route=Page_Edit_Offre&id_offre=<?=$row["id_offre"] ?> " style="color : green; margin-right:10px">Modifier</a>
                                <a href="?route=All_Offre&action=delete&id_offre=<?=$row["id_offre"] ?> " style="color : red;">Suprimer</a>
                            </td>
                        </tr>
                    <?php
                }
