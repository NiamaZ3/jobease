...
<body>
    ...
    <div class="modal">
        <div class="modal-content" >
            <form  method="POST" action= "?route=Addoffre" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                      ...
                      <input type="text" name = "company" class="form-control task-desc" >
                    
                </div>
                <div class="mb-4">
                      <label class="form-label" >Offre Location</label>
                      <input type="text" name = "Location" class="form-control task-desc" >
