...
// if(isset($_GET["offre"])){
// 	$id_offer = $_GET["offre"];
// 	$check = "SELECT * FROM status WHERE userid = '$id_user' AND id_offre = '$id_offer'";
// 	$result = $conn->query($check);
// 	if($result->num_rows > 0){
// 		echo "<script>alert('vous Avez deja envoyer cette demande')</script>";
// 	}
// 	else{
// 	$status = "INSERT INTO `status`(`userid`, `id_offre`) VALUES ('$id_user','$id_offer')";
// 	$result1 = mysqli_query($conn,$status);
// 	echo "<script>alert('La delande a ete envoyer avec succses')</script>";
                ...
                <div class="postcard__text t-dark">
                    ...
                    <ul class="postcard__tagbox">
                        ...
                        <li class="tag__item play yellow">
                            <a href="index.php?offre=<?=$row['id_offre']?>"><i class="fas fa-play mr-2"></i>APPLY
                                NOW</a>
                        </li>
                    </ul>
                </div>
